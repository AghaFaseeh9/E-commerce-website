...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="max-w-[1320px] h-[731px] mx-auto px-4 py-8">
        <h1 className="text-[48px] font-bold text-center mb-4">
          Questions Looks Here
        </h1>
        <p className="text-center text-[16px] text-gray-500 mb-8">
          Lorem Ipsum is simply dummy text of the printing and typesetting
          industry. Lorem Ipsum has been the
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[50px] p-6 rounded-lg">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border rounded-lg p-4 cursor-pointer shadow-md hover:shadow-lg bg-[#F7F7F7]"
