...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Featured Products */}
      <h1 id="featured-product" className="font-bold text-[33px] uppercase mx-[20px] sm:mx-[100px] lg:mx-[200px] text-center sm:text-left">
        Featured Products
      </h1>
      ...
      <div className="flex gap-10 justify-center sm:px-10 flex-wrap my-[40px] sm:my-[60px]">
        ...
        <div className="w-full sm:w-[270px] h-[270px] mb-6 sm:mb-0 group hover:scale-105 transition-all">
          <Image
            src="/Image (8).png"
            alt="product 1"
            width={312}
