  ...
  return (
    <div>
      ...
      <h1
        ...
        className="text-[#272343] text-[32px] font-semibold relative left-[220px] p-[50px]"
      >
        All Products
      </h1>
      ...
      <div className="flex gap-10 justify-center px-7 sm:px-10 flex-wrap my-8">
        ...
        {/* Product Card 7 */}
        <Link href="/seventhpage" passHref>
          <div className="w-full sm:w-[312px] h-[377px] relative group">
            <Image
              src="/Image (8).png"
              alt="product 3"
      ...
      <div className="bg-[#1E28320D] h-[754px] p-[20px] sm:p-[40px] md:p-[60px] my-8">
  <h2 className="text-[30px] sm:text-[40px] md:text-[50px] font-medium flex items-center justify-center">
    Or subscribe to the newsletter
  </h2>
  <div className="flex flex-col sm:flex-row justify-center px-[20px] sm:px-[50px] md:px-[300px] py-[30px] sm:py-[40px] md:py-[70px] font-medium">
    <input
      type="email"
      name="emailbox"
      id="emailbox"
      placeholder="   Email Address...."
      className="w-full sm:w-[643px] h-[32px] border-b-[2px] border-b-black mb-4 sm:mb-0"
    />
    <input
      type="button"
      value="SUBMIT"
      className="h-[31px] w-full sm:w-[91px] border-b-[2px] border-b-black sm:mx-6"
    />
  </div>
  <h2 className="text-[30px] sm:text-[40px] md:text-[50px] font-medium flex items-center justify-center">
    Follow products and discounts on Instagram
  </h2>
  <div className="flex flex-wrap justify-center gap-4 my-[20px] sm:my-[40px]">
    <Image
      src="/Image (6).png"
      alt="product 3"
      width={186}
    ...
    <Image
      ...
      height={200}
    />
    <Image src="/Image.png" alt="product 3" width={200} height={200} />
    <Image
      src="/Image (3).png"
      alt="product 3"
      width={200}
